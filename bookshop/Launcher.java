...
public class Launcher {
    public static void main(String[] args) {
        ...
        User johnSmith = new User("Smith, John", "111@222.com", new GregorianCalendar(2015, Calendar.OCTOBER, 20));
        bookshop.addUser(johnSmith);
        User jamesDaw = new User("Daw, James", "333@444.com", new GregorianCalendar(2015, Calendar.OCTOBER, 21));
        bookshop.addUser(jamesDaw);

        Payment payment = new Payment(johnSmith, book, "Some Street, 10", 1);
        payment.setDate(new GregorianCalendar(2016, Calendar.JANUARY, 1, 12, 00));
        bookshop.addPayment(payment);
        Payment payment1 = new Payment(jamesDaw, book1, "Other Street, 15", 1);
        payment1.setDate(new GregorianCalendar(2016, Calendar.FEBRUARY, 18, 12, 00));
        bookshop.addPayment(payment1);
        Payment payment2 = new Payment(johnSmith, book2, "Some Street, 10", 1);
        bookshop.addPayment(payment2);
        Payment payment3 = new Payment(jamesDaw, book3, "Other Street, 15", 1);
